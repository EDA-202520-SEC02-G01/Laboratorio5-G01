...
def eval_ratings(book1, book2):
    global data_structure
    return data_structure.default_sort_criteria(book2, book1)
...
def sort_books(catalog):
    ...
    if sort_algorithm == 1:
        sorted_books_s = data_structure.selection_sort(sorted_books,True)

    elif sort_algorithm == 2:
        sorted_books_s = data_structure.insertion_sort(sorted_books,True)

    elif sort_algorithm == 3:
        sorted_books_s = data_structure.shell_sort(sorted_books,True)

    elif sort_algorithm == 4:
        sorted_books_s = data_structure.merge_sort(sorted_books,True)

    elif sort_algorithm == 5:
        sorted_books_s = data_structure.quick_sort(sorted_books,True)
